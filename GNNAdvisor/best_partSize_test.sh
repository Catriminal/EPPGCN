...
#             re=`$gnnad --dataset $data --dim $dim --classes $classes --dataDir $dataDir --train_ratio $ratio --l1_backsize $partsize --l2_backsize $partsize`
#             # echo "$gnnad --dataset $data --dim $dim --classes $classes --dataDir $dataDir --train_ratio $ratio --l1_backsize $partsize --l2_backsize $partsize"
...
do
    ...
    do
        ...
        do
            echo "part_size: $partsize"
            re=`$gnnad --dataset $data --dim $dim --classes $classes --dataDir $dataDir --train_ratio $ratio --partSize $partsize`
            # echo "$gnnad --dataset $data --dim $dim --classes $classes --dataDir $dataDir --train_ratio $ratio --l1_backsize $partsize --l2_backsize $partsize"
